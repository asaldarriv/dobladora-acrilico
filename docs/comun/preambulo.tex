...
% XeLaTeX/LuaLaTeX leen UTF-8 nativo, pero con fuentes de 8 bits (T1) pasan el
% carácter directo a la ranura del mismo número. En el rango U+00A0-U+00BF el
% Cork encoding no coincide con Latin-1, así que «¿» salía como «£» y «¡» como
% «a». Se mapean esos caracteres a sus comandos LICR; en pdfLaTeX ya lo hace
% inputenc, por eso el bloque va sólo en el otro motor.
\ifPDFTeX\else
